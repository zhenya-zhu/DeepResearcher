...
export DEEP_RESEARCHER_PROXY_URL="http://proxy.sin.sap.corp:8080"
...
这些语义现在由 JSON registry 驱动，而不是散落在 workflow 条件分支里。默认配置文件是 [evidence_profiles.json](/Users/I561043/SAP/DeepResearcher/deep_researcher/evidence_profiles.json) 和 [source_packs.json](/Users/I561043/SAP/DeepResearcher/deep_researcher/source_packs.json)，必要时可以通过环境变量覆盖：
...
默认模型画像放在 [model_capabilities.json](/Users/I561043/SAP/DeepResearcher/deep_researcher/model_capabilities.json)。
如果你要覆盖本仓库默认值，可以设置：
...
- [docs/README.md](/Users/I561043/SAP/DeepResearcher/docs/README.md)
- [docs/planning-mode.md](/Users/I561043/SAP/DeepResearcher/docs/planning-mode.md)
- [docs/query-tests.md](/Users/I561043/SAP/DeepResearcher/docs/query-tests.md)
