...
默认模型画像现在不再写死在代码里，而是放在 [model_capabilities.json](/Users/I561043/SAP/DeepResearcher/deep_researcher/model_capabilities.json)。
...
```bash
DEEP_RESEARCHER_PLANNER_MAX_OUTPUT_TOKENS=4000
DEEP_RESEARCHER_RESEARCHER_MAX_OUTPUT_TOKENS=2200
DEEP_RESEARCHER_WRITER_MAX_OUTPUT_TOKENS=2600
...
查看一次 run 的 [trace.html](/Users/I561043/SAP/DeepResearcher/runs/20260309-102803-488320/trace.html) 时，重点看 `llm` 和 `context` 事件里的这些字段：
